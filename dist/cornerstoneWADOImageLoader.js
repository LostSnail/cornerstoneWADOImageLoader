/*! cornerstone-wado-image-loader - 2.1.4 - 2018-09-13 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstoneWADOImageLoader */
...
function loadImage(imageId, options) {
  ...
  var promise = new Promise(function (resolve, reject) {
    ...
    var tsuid = void 0;
    if (metaData['00020010'] && ("1.2.840.10008.1.2.4.90" === metaData['00020010'].Value[0] || "1.2.840.10008.1.2.4.91" === metaData['00020010'].Value[0])) {
      tsuid = metaData['00020010'].Value[0];
      mediaType = 'multipart/related; type="image/jp2"';
    } else if (metaData['00020010'] && ("1.2.840.10008.1.2.4.50" === metaData['00020010'].Value[0] || "1.2.840.10008.1.2.4.51" === metaData['00020010'].Value[0] || "1.2.840.10008.1.2.4.70" === metaData['00020010'].Value[0] || "1.2.840.10008.1.2.4.80" === metaData['00020010'].Value[0] || "1.2.840.10008.1.2.4.81" === metaData['00020010'].Value[0])) {
      tsuid = metaData['00020010'].Value[0];
    ...
    (0, _getPixelData2.default)(uri, imageId, mediaType).then(function (result) {
      var transferSyntax = tsuid || getTransferSyntaxForContentType(result.contentType);
...
function metaDataProvider(type, imageId) {
  ...
  if (type === 'imagePlaneModule') {
    ...
    if (pixelSpacing) {
      ...
      var _retrieveFramePixelSp = retrieveFramePixelSpacing(metaData);

      var _retrieveFramePixelSp2 = _slicedToArray(_retrieveFramePixelSp, 2);

      rowPixelSpacing = _retrieveFramePixelSp2[0];
      columnPixelSpacing = _retrieveFramePixelSp2[1];
    }
...
function retrieveFramePixelSpacing(metaData) {
  var frame = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  var pixelSpacingValue = (0, _lodash.get)(metaData, ['52009229', 'Value', '0', 'Value', '0', '00289110', 'Value', '0', '00280030']) || (0, _lodash.get)(metaData, ['52009230', 'Value', '0', 'Value', '0', '00289110', 'Value', '' + frame, '00280030']);

  return (0, _getNumberValues2.default)(pixelSpacingValue || { Value: [1.0, 1.0] }, 2);
}
...
function metaDataProvider(type, imageId) {
  ...
  if (type === 'imagePlaneModule') {
    ...
    var pixelSpacing = (0, _getNumberValues2.default)(dataSet, 'x00280030', 2) || (0, _getNumberValues2.default)(dataSet, 'x00181164', 2);
